...
df_v = pd.read_csv('./analysis_AVI_k3_32.dat', delim_whitespace=True, skiprows=1, header=None)
df_FD = pd.read_csv('./analysis_EC_k3_32.dat', delim_whitespace=True, skiprows=1, header=None)
...
plt.plot(df_v[1], df_v.iloc[:, -1] - df_v.iloc[0, -1], color = RWTH_Blue_RGB[0], label = r"Adaptive")
...
plt.savefig('Entropy_TGV.pgf', bbox_inches = 'tight', pad_inches = 0)
